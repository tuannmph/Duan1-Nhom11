...
<section class="swiper-slider-hero relative block h-screen" id="home">
    <div class="swiper-container absolute end-0 top-0 w-full h-full">
            ...
            <div class="swiper-slide flex items-center overflow-hidden">
                <div
                    ...
                    <!-- <div class="container relative">
                        <div class="grid md:grid-cols-2 grid-cols-1">
                            <div>
                                <span class="uppercase font-semibold text-lg">Christmas Sale 2023</span>
                                <h4 class="md:text-6xl text-4xl md:leading-normal leading-normal font-bold my-3">
                                    End of Season Sale
                                </h4>
                                <p class="text-lg">
                                ...
                                <div class="mt-6">
                                    <a href="#"
                                        class="py-2 px-5 inline-block font-semibold tracking-wide align-middle text-center bg-slate-900 dark:bg-orange-500 text-white rounded-md">View
                                        Collection <i class="mdi mdi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
        ...
        <!-- <div class="swiper-button-next bg-transparent w-[35px] h-[35px] leading-[35px] -mt-[30px] bg-none border border-solid border-slate-900/50 text-slate-900 hover:bg-orange-500 hover:border-orange-500 hover:text-white rounded-full text-center"></div>
                <div class="swiper-button-prev bg-transparent w-[35px] h-[35px] leading-[35px] -mt-[30px] bg-none border border-solid border-slate-900/50 text-slate-900 hover:bg-orange-500 hover:border-orange-500 hover:text-white rounded-full text-center"></div> -->
    </div>
    <!--end container-->
</section>
<!--end section-->
...
<section class="relative md:py-24 py-16">
            ...
            echo '<div class="group">
                <div
                    ...
                    <div class="absolute -bottom-20 group-hover:bottom-3 start-3 end-3 duration-500">
                        <a href="index.php?act=ctsanpham"
    ...
    <div class="container relative md:mt-24 mt-16">
        <div class="grid grid-cols-1">
            <div
                class="relative overflow-hidden rounded-md shadow dark:shadow-gray-800 py-20 px-4 md:px-10 bg-orange-600 bg-[url('../../assets/images/hero/bg2.html')] bg-no-repeat bg-cover">
                <div
                ...
                <div class="grid md:grid-cols-2 grid-cols-1 items-end gap-6 relative z-1">
                    ...
                    <div class="md:text-end">
                        <a href="sale.html"
                            class="py-2 px-5 inline-block font-semibold tracking-wide align-middle text-center bg-white text-orange-500 rounded-md">Offer
                            Grab Now</a>
                    </div>
                </div>
                <!--end grid-->
    ...
    <!-- <div class="container relative md:mt-24 mt-16">
        ...
        <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 pt-6 gap-6">
            <div class="group">
                <div
                    class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                    <img src="assets/images/shop/trendy-t-shirt2.jpg" class="group-hover:scale-110 duration-500"
                        alt="" />
            ...
            <div class="group">
                <div
                    class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                    <img src="assets/images/shop/men-sun-glasses.jpg" class="group-hover:scale-110 duration-500"
                        alt="" />
