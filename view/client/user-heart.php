    ...
    <div class="container relative md:mt-24 mt-16">
        <div class="md:flex">
            ...
            <div class="lg:w-3/4 md:w-2/3 md:px-3 mt-6 md:mt-0">
                ...
                <h5 class="text-lg font-semibold my-6">Sản phẩm yêu thích</h5>

                <div class="rounded-md shadow dark:shadow-gray-800 p-6">
                    <ul>
                        <li class="flex justify-between items-center pb-6">
                            <div class="flex items-center">
                                <img src="assets/images/shop/apple-smart-watch.jpg"
                                    class="rounded shadow dark:shadow-gray-800 w-16" alt="">

                                <div class="ms-4">
                                    <a href="#" class="font-semibold hover:text-orange-500">Apple Smart Watch</a>
                                    <p class="text-green-600 text-sm mt-1">$16.00 <del class="text-red-600">$21.00</del>
                                    </p>
                                </div>
                            </div>
                        ...
                        <li
                            ...
                            <div class="flex items-center">
                                <img src="assets/images/shop/ladies-2.jpg"
                                    class="rounded shadow dark:shadow-gray-800 w-16" alt="">
                        ...
                        <li
                            class="flex justify-between items-center pt-6 border-t border-gray-100 dark:border-gray-700">
                            <div class="flex items-center">
                                <img src="assets/images/shop/ladies-sun-glasses.jpg"
                                    class="rounded shadow dark:shadow-gray-800 w-16" alt="">
