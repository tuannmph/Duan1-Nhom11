     ...
     <div class="container relative">
         ...
         <div class="relative mt-3">
             <ul class="tracking-[0.5px] mb-0 inline-block">
                 ...
                 <li class="inline-block uppercase text-[13px] font-bold text-orange-500" aria-current="page">Shopcart
                 </li>
             </ul>
         </div>
     </div>
                 ...
                 <table class="w-full text-start">
                     ...
                     <tbody>
                         <tr class="bg-white dark:bg-slate-900">
                             ...
                             <td class="p-4">
                                 <span class="flex items-center">
                                     <img src="assets/images/shop/black-print-t-shirt.jpg"
                         ...
                         <tr class="bg-white dark:bg-slate-900 border-t border-gray-100 dark:border-gray-800">
                             ...
                             <td class="p-4">
                                 <span class="flex items-center">
                                     <img src="assets/images/shop/fashion-shoes-sneaker.jpg"
                                         class="rounded shadow dark:shadow-gray-800 w-12" alt="">
                                     <span class="ms-3">
                         ...
                         <tr class="bg-white dark:bg-slate-900 border-t border-gray-100 dark:border-gray-800">
                             ...
                             <td class="p-4">
                                 <span class="flex items-center">
                                     <img src="assets/images/shop/ladies-skirt-pair.jpg"
                                         class="rounded shadow dark:shadow-gray-800 w-12" alt="">
                                     <span class="ms-3">
         ...
         <div class="grid md:grid-cols-12 grid-cols-1 items-center">
             ...
             <div class="lg:col-span-7 md:col-span-6">
                 ...
                 <div class="my-5">
                     ...
                     <a href="#"><img src="assets/images/playstore.png" class="m-1 inline-block" alt=""></a>
                 </div>
                 ...
                 <div class="inline-block">
                     <div class="pt-4 flex items-center border-t border-gray-100 dark:border-gray-800">
                         ...
                         <div class="content">
                             ...
                             <a href="#" class="text-orange-500">Learn More <i class="mdi mdi-arrow-right"></i></a>
                         </div>
                     </div>
                 </div>
             </div>
