...
<section class="relative table w-full py-20 lg:py-24 md:pt-28 bg-gray-50 dark:bg-slate-800">
    <div class="container relative">
        ...
        <div class="relative mt-3">
            <ul class="tracking-[0.5px] mb-0 inline-block">
                <li class="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-orange-500">
                    <a href="index.html">Cartzio</a></li>
                <li class="inline-block text-base text-slate-950 dark:text-white mx-0.5 ltr:rotate-0 rtl:rotate-180"><i
                        class="mdi mdi-chevron-right"></i></li>
                <li class="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-orange-500">
                    <a href="shop-grid.html">Store</a></li>
                ...
                <ul class="product-imgs flex list-none items-center">
                    <li>
                        <ul class="img-select list-none">
                            <li class="p-px">
                                <a href="#" data-id="1">
                                    <img src="assets/images/shop/mens-jecket.jpg" class="shadow dark:shadow-gray-800"
                                        alt="">
                                </a>
                            </li>
                            <li class="p-px">
                                <a href="#" data-id="2">
                                    <img src="assets/images/shop/mens-jecket-3.jpg" class="shadow dark:shadow-gray-800"
                                        alt="">
                                </a>
                            </li>
                            <li class="p-px">
                                <a href="#" data-id="3">
                                    <img src="assets/images/shop/mens-jecket-left.jpg"
                                        class="shadow dark:shadow-gray-800" alt="">
                                </a>
                            </li>
                            <li class="p-px">
                                <a href="#" data-id="4">
                                    <img src="assets/images/shop/mens-jecket-back.jpg"
                                        class="shadow dark:shadow-gray-800" alt="">
                                </a>
                            </li>
                            <li class="p-px">
                                <a href="#" data-id="5">
                                    <img src="assets/images/shop/mens-jecket-4.jpg" class="shadow dark:shadow-gray-800"
                                        alt="">
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="img-display shadow dark:shadow-gray-800 m-px">
                        <div class="img-showcase flex w-full duration-500">
                            <img src="assets/images/shop/mens-jecket.jpg" class="min-w-full" alt="shoe image">
                            <img src="assets/images/shop/mens-jecket-3.jpg" class="min-w-full" alt="shoe image">
                            <img src="assets/images/shop/mens-jecket-left.jpg" class="min-w-full" alt="shoe image">
                            <img src="assets/images/shop/mens-jecket-back.jpg" class="min-w-full" alt="shoe image">
                            <img src="assets/images/shop/mens-jecket-4.jpg" class="min-w-full" alt="shoe image">
                        </div>
                    </li>
                </ul>
            </div>
